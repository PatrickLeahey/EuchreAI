...
class Player:
    ...
    def __init__(self,team):
        ...
        self.name = ''
        self.seat = None
        self.card_played_this_trick = None
    ...
    def get_player_team_score(self):
        return self.team_score
    
    def add_to_player_team_score(self,amount):
        self.team_score = self.team_score + amount
    
    def reset_player_team_score(self):
        self.team_score = 0
    ...
    def play_card(self,played_so_far):
        ...
        self.card_played_this_trick = card_to_play
        return card_to_play
