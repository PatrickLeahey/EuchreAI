...
names = ['George Washington','John Adams','Thomas Jefferson','James Madison','James Monroe','John Quincy Adams','Andrew Jackson', \
		'Martin Van Buren','William Henry Harrison','John Tyler','James K. Polk','Zachary Taylor','Millard Fillmore','Franklin Pierce', \
		'James Buchanan','Abraham Lincoln','Andrew Johnson','Ulysses S. Grant','Rutherford B. Hayes','James Garfield','Chester A. Arthur', \
		...
		'Lyndon B. Johnson','Richard M. Nixon','Gerald R. Ford','James Carter','Ronald Reagan','George H. W. Bush','William J. Clinton', \
