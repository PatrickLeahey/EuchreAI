    ...
    def next_dealer(self):
        ...
        if True in [player.is_dealer() for player in self.players]:
            ...
            if dealer_index != 3:
                ...
                self.players[lead_index].toggle_dealer()
                if lead_index != 3:
                    self.table.set_first(self.players[lead_index])
                else:
                    self.table.set_first(self.players[0])

            else:
                self.players[0].toggle_dealer()
                self.table.set_first(self.players[1])
        else:
            self.players[0].toggle_dealer()
            self.table.set_first(self.players[1])
